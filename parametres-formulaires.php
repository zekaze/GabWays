                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="date" id="champ_texte-52" name="champ_texte-52"
                                                       class="form_input"
                                                       placeholder="Date de debut...">
                                            </div>
                                            <div class="col-sm-6">
                                                <label for="champ_texte-53">Date de fin</label>
                                                <input type="date" id="champ_texte-53" name="champ_texte-53"
                                                       class="form_input"
                                        ...
                                        <input type="text" id="champ_texte-54" readonly class="form_input"
                                               placeholder="Coût..">
